...
RSpec.configure do |config|
  ...
  # Changed above per Avdis post: http://devblog.avdi.org/2012/08/31/configuring-database_cleaner-with-rails-rspec-capybara-and-selenium/
  ...
  # for capy webkit - js
  #Cabybara.javascript_driver = :webkit
